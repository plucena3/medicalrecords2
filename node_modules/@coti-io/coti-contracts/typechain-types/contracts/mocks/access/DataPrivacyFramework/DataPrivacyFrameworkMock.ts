...
export interface DataPrivacyFrameworkMockInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADDRESS_ALL"
      | "STRING_ALL"
...
export interface DataPrivacyFrameworkMock extends BaseContract {
  connect(runner?: ContractRunner | null): DataPrivacyFrameworkMock;
  waitForDeployment(): Promise<this>;

  interface: DataPrivacyFrameworkMockInterface;
