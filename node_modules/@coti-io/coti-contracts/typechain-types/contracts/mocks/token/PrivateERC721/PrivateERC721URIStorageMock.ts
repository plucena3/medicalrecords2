...
export interface PrivateERC721URIStorageMock extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC721URIStorageMock;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC721URIStorageMockInterface;
