...
export interface PrivateERC20MockInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface PrivateERC20Mock extends BaseContract {
  connect(runner?: ContractRunner | null): PrivateERC20Mock;
  waitForDeployment(): Promise<this>;

  interface: PrivateERC20MockInterface;
